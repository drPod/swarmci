...
def explore(
    ...
    if cloud and not settings.browser_use_api_key:
        raise typer.BadParameter("Set BROWSER_USE_API_KEY in .env to use Browser Use Cloud")
    config = RunConfig(
